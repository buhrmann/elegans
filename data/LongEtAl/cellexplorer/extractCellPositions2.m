function extractCellPositions2(datadir,ind, locfilename, cellNameFile, cellnumanno)
% function extractCellPositions2(datadir,ind, locfilename, cellNameFile, cellnumanno)
% 
% extract X,Y,Z positions of each segmentated nucleus
%
% cellNameFile, cellnumanno are not necessary for real case, only used for
% recognition algorithm testing purpose to generate XPos, YPos, ZPos, and
...
itermno = 12; 
detectedPos = zeros(length(ind),cellnumanno); 
XPosb4 = [];
YPosb4 = [];
ZPosb4 = [];
cellrecog = [];
